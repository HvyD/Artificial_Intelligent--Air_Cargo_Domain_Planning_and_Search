...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
        ...
        # Q. create concrete Action objects based on the domain action schema for: Load, Unload, and Fly
                ...
                for p in self.planes:
                    for a in self.airports:
                            precond_pos = [expr("At({}, {})".format(c, a)),expr("At({}, {})".format(p, a)),
                                         #  expr("Cargo({})".format(c)),expr("Plane({})".format(p)),expr("Airport({})".format(a))
                                           ]
                            precond_neg = []
